            ...
            <div class="w-5/12 ">
                <div class="pb-8">
                    <div class="relative flex items-center">
                        ...
                        <input type="text"  wire:model.defer="number.phone" :error="$errors->first('number.phone')" placeholder="+44123456789" autocomplete="off" autofocus="true" @keydown.enter="send" class="text-md w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-5 pr-16 bg-gray-100 border-2 border-gray-200 focus:border-blue-500 rounded-full py-2" x-ref="input" />
